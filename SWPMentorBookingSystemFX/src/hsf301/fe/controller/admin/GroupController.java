...
public class GroupController {
    ...
    @FXML
    private TextArea txtPoint; // Change TextField to TextArea to match FXML

    private ProjectGroupService projectGroupService;

    public GroupController() {
        this.projectGroupService = new ProjectGroupServiceImpl(); // Initialize ProjectGroupService
    }
    ...
    public void initialize() {
        ...
        leaderName.setCellValueFactory(cellData -> {
            ...
            return new SimpleStringProperty(projectGroup.getLeader() != null ? projectGroup.getLeader().getStudentName() : "");
        });
    ...
    public void btnAdd() {
        ...
        if (txtPoint.getText() != null && !txtPoint.getText().isEmpty()) {
            try {
                ...
                AlertController.showAlert(AlertType.CONFIRMATION, "Add points successful!", "Points added successfully!");
                groupTable.refresh();
            } catch (NumberFormatException e) {
                AlertController.showAlert(AlertType.WARNING, "Invalid Input", "Please enter a valid number for points.");
            }
        } else {
