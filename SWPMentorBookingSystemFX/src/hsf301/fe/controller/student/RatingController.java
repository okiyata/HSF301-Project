...
public class RatingController {
    ...
    private void loadAppointments() {
        ...
        List<Appointment> appointments = appointmentService.findFinishedAppointmentsWithoutGroupRating(student.getProjectGroup().getGroupID());
